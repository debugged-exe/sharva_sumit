...
const MerchantDise = () => {
  return (
    ...
    <div className="join_us bg-dark d-flex  justify-content-center my-5 py-3">
        ...
        <div className="button m-4"><button className='bg-white px-4 p-2 rounded-pill '>join us now</button></div>
    </div>
    </div>
  )
}
